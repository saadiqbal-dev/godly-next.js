...
const PlantationCta = () => {
  ...
  if (city !== "PLANTATION") return null;
    ...
    <div className="paper-bg-16 bg-[#262424] flex flex-col items-center justify-center gap-6 py-20 px-8">
      <div className="max-w-4xl text-center">
        ...
        <p className="text-lg text-white mb-8 md:text-xl">
          Whether you're in Central Park, Plantation Isles, or a gated community—{" "}
          ...
          is your trusted partner for high-quality window cleaning and exterior care in Plantation.
        </p>
