...
const LauderdaleByTheSeaCta = () => {
  const { city } = useGodlyContext();

  if (city !== "LAUDERDALE-BY-THE-SEA") return null;
    ...
    <div className="paper-bg-16 bg-[#262424] flex flex-col items-center justify-center gap-6 py-20 px-8">
      <div className="max-w-4xl text-center">
        <h2 className="text-3xl font-bold text-[#FDE4C8] mb-6 md:text-4xl lg:text-5xl">
          Expert Window & Exterior Cleaning in Lauderdale-by-the-Sea
        </h2>
        <p className="text-lg text-white mb-8 md:text-xl">
          Whether you live on A1A, in Bel-Air, or by the shoreline—{" "}
          ...
          is your trusted team for spotless windows and expert exterior care in Lauderdale-by-the-Sea.
        </p>
...
export default LauderdaleByTheSeaCta;